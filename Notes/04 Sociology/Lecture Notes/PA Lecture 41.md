...
| --------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Karl Marx**         | Theory of Alienation            | • Disconnect between producer and product<br>• Cannot be overcome in capitalist society<br>• Solution: Communist society                                     |
|                       | Historical Materialism vs Hegel | • Marx: Materialism, Hegel: Idealism<br>• Dialectics common to both<br>• Three laws of dialectics                                                            |
|                       | Marx vs Durkheim                | • Marx: Unhopeful about modern society<br>• Durkheim: Hopeful, anomie is transitional<br>• Both analyze turmoil of industrial capitalism                     |
| **Max Weber**         | Iron Cage Theory                | • Bureaucracy as specialists without spirit<br>• Rewards compliance, penalizes innovation<br>• Counter: Can do innovative work within framework              |
|                       | Ideal Types & Authority         | • Mental constructs, don't correspond to reality<br>• Three forms of legitimate domination<br>• Authority is form of power, not all power is authority       |
|                       | Weberian Bureaucracy            | • Features result in efficiency, speed, predictability<br>• Technically superior to other organizations<br>• Critics: Features lead to alienation            |
|                       | Protestant Ethic                | • Facts: Empirical basis linking Protestantism-capitalism<br>• Values: Predestination, calling<br>• Value relevant choice but objective analysis             |
| **G.H. Mead**         | Theory of Self                  | • Self develops when individual becomes self-conscious<br>• Game stage for selfhood attainment<br>• Symbolic interactionism, generalized/significant other   |
|                       | Self and Society Twinborn       | • Two sides of same coin<br>• Self formed by society interactions<br>• Selves impact society back                                                            |
| **Religion**          | Tyler vs Max Mueller            | • Tyler: Spirit worship<br>• Max Mueller: Nature worship<br>• Both contributed to sociological understanding                                                 |
|                       | Durkheim vs Weber               | • Durkheim: Social stability, primitive religion<br>• Weber: Social change, comparative study<br>• Different personal connections to subject                 |
|                       | Religion & Fundamentalism       | • Seems primarily religious but non-religious factors<br>• Steve Bruce: Single book religions more prone<br>• Problematic when clashes with other viewpoints |
| **Stratification**    | Ethnicity Contemporary          | • Growing salience with illustrations<br>• Examples: Palestine-Israel, Manipur, US racial conflict                                                           |
|                       | Davis-Moore Theory              | • Functional necessity for role allocation<br>• Unconscious device for automatic sifting                                                                     |
|                       | Marx vs Weber                   | • Marx: Two classes, inevitable revolution<br>• Weber: Four classes, expanding middle class<br>• Both: Economic factors important, small business struggles  |
| **Political Parties** | Definition & Functions          | • Organized structures seeking power through elections<br>• Pluralist: Represent diverse sections<br>• Nine key functions from sensitization to power check  |
|                       | Evolution Pattern               | • Widen support base over time<br>• BSP: Anti-upper caste to Sarva Samaj<br>• Modi: "Islam religion of peace"                                                |
| **Pressure Groups**   | Definition & Methods            | • Put pressure to protect member interests<br>• Examples: FICCI, CII, IMA, trade unions<br>• Methods: Petitions, protests, funding, expertise                |
|                       | vs Political Parties            | • Don't seek power vs seek power<br>• Narrow focus vs wide representation<br>• Explicit sectional work vs balance demands                                    |
|                       | Relationship                    | • Antagonistic cooperation<br>• Conflict: Pressure vs balance<br>• Cooperation: Information, alignment, support base                                         |
| **Social Movements**  | Collective Action Types         | • Crowd: Same emotion<br>• Public: Common cause<br>• Mass: Common communication<br>• Social Movement: Jan Andolan                                            |
|                       | Definition & Characteristics    | • Collective, sustained, organized effort<br>• Change-oriented (demand or prevent)<br>• Formal/informal organization                                         |
|                       | Significance                    | • Change laws/policies (RTI, Section 377)<br>• Change social relationships (Dalit movement)<br>• Change practices/norms/values                               |
|                       | Theoretical Frameworks          | • Lebon: Crowd psychology, contagion effect<br>• Jenkins: Resource mobilization, entrepreneur leaders<br>• Need money, people, media, infrastructure         |
