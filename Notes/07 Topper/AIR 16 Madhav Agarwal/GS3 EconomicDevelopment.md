...
- Macroeconomy Effects of liberalization on the economy
...
2.  2012- Why is international trade perceived to have failed to act as an “engine of growth” in many developing countries including India?
3.  2009- Evolving India’s stand at WTO negotiations such that it is diluting its stand on agriculture issues to pursue perceived gains in services
...
4.  2014: National Urban Transport Policy: Moving people and not moving vehicles; Critically discuss their success
    1.  Roads transport: Ails, remedies, Status? MV Act?
5.  **Energy Policy and Sources - Conventional, Renewable and Alternative Energy Sources**
...
2.  Atma Nirbhar Bharat: Liberalisation vs Protectionism
    1.  And that is why the outlook of Atmanirbhar Bharat (self-reliant India) is important for the world. This is not about protectionism; it is about building greater strengths at home to **play more effectively abroad**. **(eg: Hydrooxycholoro drug, med team support,**
3.  2016- Justify need for FDI for dev of indian economy. Why gap btw MOU signed and actual FDI? Suggest remedial steps for increasing actual FDI in india?
4.  2014-FDI in defence sector? Influence on defence and economy in short and long run?
    1.  Cover angle of self reliance in defence sector
5.  2013-impact of FDI entry into Multi-trade retail sector on SCM in commodity trade pattern of the economy
6.  2013-Reasons for FDI not picking up in Multi-trade retail sector
7.  FDI: Trend? Status and performance of FDI post 1991
...
### 3. Mobilization of resources, Financial Intermediation (Banking, Insurance, Capital Markets, External Resources), Budgeting
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 4.jpeg]]
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 5.jpeg]]
...
- Finances are in poor state: as evidences by operating ratio of > than 95%, Increase in staff costs are outpacing the growth in traffic revenues (experts also feel that this op ratio is under-reported where actual ratio is >110%)
...
- Way Fwd: The need of the hour is to find a balanced solution that would incorporate the pros of both private and government enterprises and enhance the image of Indian Railways as it continues to serve the world’s largest democracy.
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 6.jpeg]]
...
3.  Congestion of roads connecting the port leading to time delays as seen in JLN port.
4.  Turnaround time is as high as 3 to 4 days compared to average time of 6-7 hrs in other developed ports because of cumbersome documentation and clearance.
    1.  Custom clearance issues, politicization and labour union at port issues
5.  Currently the ports operate on Trust model where government is the owner and operator of the port. We need to shift towards Land-lord tenant model where private sector can operate the port.( Therefore- Major ports bill)
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 7.jpeg]]

#### Way forward

- faster imp, write basic points
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 8.jpeg]]
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 9.jpeg]]
- India world’s 3rd largest energy consumer- goal to give billions cheap, relaible 24/7 energy. However our per-capita is 1/3rd of global average
...
- Explain affordable (to ensure inclusive growth), reliable (no dependence on OPEC), sustainable (env benefits), modern energy (evolving and sunrise industry)
- Imp of energy = upliftment of downtrodden, education, economic life (mention respective SDGs)
- _Energy to be interpreted in broader terms therefore also incl LPG_
...
- Cover schemes of RE
- Schemes subsidies for solar panels, lamps, irrigation pumps, biogas plants; Small hydro projects, wind mills, biogas, bagassee..

##### Modern energy

- To encourage families to switch from wood and kerosene to LPG - **PAHAL Scheme**
- Cover some schemes of RE

#### 2017: Current policies in framework ‘transform, energize and clean India’

- Budget 20-21: The central ideas of the **Budget** are "Aspirational India, Economic development, A Caring Society"
- Budget 21-22: The Budget rest on 6 pillars.
...
- Add points to latest budget after studying budegt separately

#### 2013: Write a note on India’s green energy corridor to alleviate the problem of conventional energy

- The **Green Energy Corridor Project** aims at synchronizing electricity produced from renewable sources, such as solar and wind, with conventional power stations in the grid. (from generation points to the load centres through transmission infrastructure)
- Collaboration with Germany to enforce the same
...
- Loans from **Asian Development Bank** for the project implementation.
...
- Need for energy security- Rural,Inclusive growth,Industrial rev 4.0, very low per capita energy consumption etc
- Energy dependence- Oil imports, Coal imports,Solar panel imports
- However- thriving thermal industry, increased solar adoption, Int efforts
...
- **National Program for LED** has 2 components:
    - **Unnat Jyoti by Affordable LEDs for All (UJALA)**: Distributed 36 crore LED bulbs → reduced elec bill → inc in disposable income → env friendly
...
- Coal Energy: Economic survey suggestions / observations:
    - 1. **Carbon Imperialism** is a modern day type of imperialism wherein the 1st world nations are trying to enforce their views about energy-consumption upon the 3rd nations with hidden agenda to 1) To sell their nuclear fuel and technology. 2) To portray the third world in bad light for using coal power and thereby reducing their own culpability (दोषी/ दण्डयता) for global warming.
...
- **Engineering, Procurement and Construction (EPC) Model**: (its kind of outsourcing/contracting) • Under this model, the cost is completely borne by the government. Government invites bids for engineering knowledge from the private players. • The private sector’s participation is minimum and is limited to the provision of engineering expertise
    - In these models, the private player is not given ownership of infrastructure or right to collect toll/user fee at any point of time
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 10.jpeg]]
...
- Pvt. player does not bother to look for efficient delivery of service → present contracts do not incentivise better service
...
- Ensure pvt dont make unsustanabile expenditure in non core things

#### Arrangements to ensure sustanainbility for future
...
### 2016, 2013: Pros and cons of PPP Model (wrt developments of Airports asked in exam)

1.  Collect current examples wrt different investment models

### 2014: Explain how Private Public Partnership arrangements, in long gestation infrastructure projects, can transfer unsustainable liabilities to the future. What arrangements need to be put in place to ensure that successive generations’ capacities are not compromised?
...
## Effects of liberalization on the economy, FDI
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 11.jpeg]]
...
- Financial market
    - Banking- Private, foreign banks, pvt insurance co rec by **NARSIMHAN COMMITTEE**, Mergers of PSB for effetive credit growth
...
- COVID-19 led to devastation of supply chains and revealed gaps in current scenario; ANB which aims to move from reliance to self-reliance and accentuates manufacturing-led, export-driven growth
...
- Supply Chain Fragility: Need domestic supply chain for critical products(API-China issue), PPE kits shortage etc can precipate into national security crisis
...
- Japan dev its automobile segment; S. Korea did for consumer durables (No country has leapfrogged into prosperity without growing its manufacturing sector through structural transformation. India needs the same)
...
- Requires increased state investment in R&D and education; We missed the 3rd revolution bus in the past due to efforts not being taken to modernise PSUs and private sector being content in protected markets; We need to catch the 4th revolution bus for sure
...
- Negative impacts due to Liberlization
    ...
    - Ecommerce- Amazon affecting local shopkeepers with deep discounts
- However positive impacts
    ...
    - Booming startup culture with more than 30 Unicorns in India
- Way forward
...
- 51% FDI into multi-trade retail sector was introduced in India. It involves minimum investment of $100 million and a mandatory 50 per cent capital reinvestment in back-end operations. It also mandates 30% sourcing from small scale industries
...
- Need for export led growth
    ...
    - Limitation of Public Expenditure: post-Covid, India’s debt has been expected to rise from about 70% of GDP to about 85-90% and fiscal deficit is likely to be in the double-digit range- helicopter money not sustainable for contd. growth
...
- strategic effort to encourage developement of industrial sector by focussing on broad and sector specifc policies
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 12.jpeg]]
...
### 2015- Impediments in marketing and supply chain management industry? Can e-commerce help?

### 2014: Reasons for direct jump to services sector? Reasons for the huge growth-services vis-a-vis industry? Can India become a developed country without a strong industrial base?
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 13.jpeg]]

#### Significance

- Employs 12 crore people; 30% of GDP; 40% of exports, 45% of manuf output
...
- Check urban migration, flag bearer of 5 Trillion goal; Spread across India unlike big units which are cluster based
...
- Since the SEZ Act came into force in 2005, over 2 million jobs have been createdThe share of SEZ exports in India’s total exports value has grown to around 30% in 2018-19. Currently there are more than 200 SEZ in India
...
- India has become the fourth country in the world where **World Economic Forum** has opened its ‘Centre for Fourth Industrial Revolution’. It is working collaboration with **NITI Aayog** with current focus on Artificial Intelligence, Blockchain and drones.
...
- India has the highest mobile data consumption in the world
...
- India missed the 1st IR due to colonial rule, it must tap this opportunity and ensure benefits are shared by all
...
### Issues related to mob of Natural resources

- unable to exploit domestic resources fully - huge import of petroleum,coal, tribal issues, judicial activism, tech issues.
...
![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 1.png]]
...
- India opted for above measures because there was no multilateral consensus in sight on this issue. Once a multilateral consensus comes into play we can align with the same
...
- With multiple jurisdictions involved including India, there is a need for a multilateral consensus as taxation of digital economy is a sensitive and complicated matter
...
- **Saving** is a choice to forego some current consumption in favor of increased future consumption. Economic conditions, social institutions, and individual or population characteristics can all influence the savings rate.
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 15.jpeg]]![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 2.png]]
- Factors for growth written above
...
- The household sector is the largest contributor to domestic saving. Savings are converted into investment with the role of financial sector’s intermediation in the process.
...
- Acc to **CARE** ratings- Gross NPA- ~8% for all banks and ~10% for PSB Banks
...
- SMA 0, 1, 2 categories for proactive supervision
...
- **YESHWANT M DEOSTHLEE COMMITTEE**- Public credit registry
- Infusion of Capital
- FM **N SITHARAMAN** said ‘Banks must not fear 3Cs - CAG, CBI. CVC
- **KV KAMATH COMMITTEE**: Bucketing accounts into mild, moderate, severe stress while restructuting stressed asset during COVID-19; Focus on 26 key sectors (power, construction, NBFC) for quick turnaround
...
- NBFC ALM → Not able to refinance → IL&FS Default → Investors such as Mutual Funds became risk averse towards the whole sector → Liquidity crunch → Spill over effects on MSME sector and infrastructure projects

##### Challenges faced by NBFC

- Multiple regulators; Write about ALM

##### Measures taken

- Special liquidity scheme for NBFCs through SPV by RBI; Targeted LTRO; Partial Credit Guarantee Scheme; Special Liquidity facility for Mutal Funds; ‘**Utkarsh 2022**’ roadmap to imbibe global practices & improve regulation of RBI

#### Issues with Urban Cooperative Banks

##### Background

- Co-operative Banks to come under the regulation of RBI; RBI will have power to supersede the board if such bank is in distress; Administrative matters will still be dealt by Registrar Cooperative

##### Regulatory

- Dual regulation, Ignoring guidelines of RBI

##### Structural

- Whole bank comes down due to correlated local risk as most UCB have single branch; Small capital base

##### Weak management and professionalism

- Politically bent interests

##### Way Fwd

- Independent external audit mechanism; Using Tech; ⬆ Investor’s awareness & confidence
...
4.  If agree- debt restructing, if not- liquidate
...
- Information Utility maintained by IBBI
...
- Approval of amalgamation of ten PSBs
...
- A **bad bank** is technically an asset reconstruction company that buys bad loans (NPAs) from the commercial banks (generally PSBs) at a discount and tries to recover the money from the defaulter by providing a systematic solution over a period of time.- can help in reviving lending and credit growth
...
- So long as PSB influencedby politicians and bureaucrats, their deficit in professionalism will remain and subsequently, prudential norms in lending will continue to suffer.
- Therefore, the debate regarding setting up a bad bank must be preceded by proper implementation of holistic reforms in the banking sector, as envisaged under the **IndraDhanush plan**.
...
- Corp debt only 16% of GDP; No hedging market (credit default swap); No strong secondary market (bonds once bought cannot be resold)

##### Suggestions

- Bring Corporate Bond Index; Standardization of terms & process; Broaden Investor Base

##### Way Fwd

- Awareness ⬆, Security measures ⬆, Investor confidence ⬆

#### Nationalisation of Banks 50 years

##### Background

- India was facing droughts, Low agri credit, Plan holiday 1966-69; Nexus b/w banks and industrial class (conflict of interest - directors) → Banks were failing frequently

##### +ves

- Branches ⬆ by 800%, PSL Norms, Jobs ⬆

##### -ves

- Political interference, Low efficiency, administered interest rate caused repression of households
...
- Tax rates on goods got reduced in GST
...
- **Public expenditure management** deals with allocation of government’s limited economic resources into three channels 1) public administration 2) economic growth 3) welfare schemes.
- PEM should consider
    - Fiscal discipline
    - Allocative efficiency- what is right for country and population
    - Operational Efficiency- cost effective and efficient service delivery
- Challanges for PEM in post-lib period:
...
- Exeptions benefits- can nudge for various sectors- auto etc
- Demerits- Tax forego, misused by well off by help of smart CA’s
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 16.jpeg]]
- Current issues in budgeting framework
...
- Other Types of Budgets
    ...
    - ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 3.png]]
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 4.png]]
...
- Analyse on investor confidence towards India; Exchange rate risk; High taxes in future; Larger part of exp going for interest rather than social purpose; Crowding out; Debt trap
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 17.jpeg]]
- Terms to be used in the answer: Fiscal Slippage, Fiscal Glide
...
- Circumventing FRBM via eg: Interim dividend from PSUs

##### Way Fwd: Measures to Strengthen FD
...
- Cover how fiscal deficit is justified by the Chapter 2 of latest Economic Survey
...
- Resources in a country are limited whether natural resources or human resources- need for proper

#### Objectives

- (refer Images below - use NITI Aayog’s objectives)
- Economic Growth
- Reduction of Economic Inequalities
- Balanced Regional Development
- Modernization
- Reduction of Unemployment
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 18.jpeg]]
- NITI Aayog’s entire gamut of activities can be divided into four main heads (refer image)
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 19.jpeg]]
...
- Ensure growth is inclusive, sustained, clean and formalised
- Use Graphs in ans like below
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 20.jpeg]]
...
- Determinants: Think of factors that determine various types of GDP
...
- Positives of Indian economy due to
    ...
    - Low Inflation (think on C/I/G/X-M)
        ...
        - Steady inflation- positive enviorment to individuals and firms
...
- Agricultural bills
- Infrastructure- coal mining privatise, railway, energy, roads etc
- Reforms needed- Analyse acc to GS3 - Eco Agri syllabus

## Inclusive Growth (IG)

### Definition

- According to WB , IG refers to both pace and pattern of growth
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 21.jpeg]]
...
- Give link btw need of inclusive growth and efficient manpower implementating it
- Education- bad teachers
- Health- doctors
- Need for Skill dev
- Better employement
...
### North East Region’s development

#### Problems

- Geographic Isolation, Perceived difference, Low agricultural productivity, Low credit flow from banks, Absence of large scale industrial base, Lack of infrastructural facilities

#### Initiatives

- **Restructured National Bamboo Mission** (increase the area under bamboo cultivation & marketing; integral part of our life and culture; 13% of indian forests), Increased budgetary allocation for rail/road/air infra,
- **Employment Generation Mission** (skill development initiative), **NERCOMP** (women empowerment), **Act East Policy** (depends upon connectivity projects in India's North East region) **Niti Forum for North-East** (exclusive forum at the NITI AAYOG; coined the concept of “**HIRA**” Highways, Inland Waterways, Railways and Airways for NE development),
...
### 2016- How Globalization led to reduction in formals sector employement? Is increased informalisation detrimental to dev of indian economy?
...
### 2015: Jobless growth: Do you agree? Give arguments

- Growth which does not translates into meaningful jobs
- Fact on unemployemet along with increasing GDP %
...
- Other reasons for unemployement
- Write about govt schemes for employement
- Then way forward
...
- In 2014, **Ministry of Skill Development and Entrepreneurship** was created to harmonise training processes, assessments, certification and outcomes ,develop Industrial Training Institututes (ITIs), sector specific skill councils
...
- **SANKALP, 2017**Creating convergence among all skill training activities, improving quality of skill development programmes, creating industry led and demand driven skill training capacity.
...
- **Issues**: No universal social security (as application of law still depends on size of firm eg: Maternity Benefits to estab employing 10+worker & where estab does not incl informal sector); Overlapping definitions; To avail schemes its mandatory to link with Aadhar (thus violating Puttaswamy judgement as link can be made mandatory only when funds recd. from CFI)
    - Informal workers (91% of workforce) had provision for registration under Unorganised Workers Act 2008 but still large no. of them remain outside SS ambit due to: Lack of awareness, Lack of Digital literacy, Absence of tangible EE-ER r’ship makes it difficult to furnish proofs of livelihood & income required for registration at the portal
...
- **Key Ideas**: Lethal mix, Tripartite compact needed to grow at 7%, LIC requirements, 80 lac jobs, FTA, 6 pronged strategy (incl skil, Infra-dig/soc/phy, Employment)
...
- AT&C 17%, DBT (2.7 lcr),
- Climate change (Eco impact by RBI report - Loss 3-10% annually by **2100** under different scenarios);
...
- **WF**: **Robust data collection**/processing; **Update base year** (**which is decade old**);
...
- **Positives as per RBI Report**: **Gross Fiscal Deficit** to GDP decline below 3%; Increased Capital Outlay - now ~3% of GDP
...
#### Disinvestment (only 10k of 51k target met)

- **Why not met**: - **Geopol uncertainty** (pandemic, R-UK); **Under-valuation** of assets; **Fear of labour** unrest

#### Food Inflation at **9.2%** in **August 2023** as per **CPI**

- As per ICRIER, farmers lost **₹45,000** crore due to **cereal exports ban**

#### IBC

- **+ves** (**NPA** now around **3**%; Better perf than SARFAESI); **WF**: **IBBI said atleast 1 meeting per mnth by Resolution professionals**; **Standardise the valuation methodologies**; Introduction of voluntary mediation as per TK Vishwanathan Cmt

#### G20 countries adopted **New Delhi Leaders’ Declaration** which called for **effective regulation of crypto assets**

- In India: Taxation on VDA; Ambit of PMLA; **RBI sees it as threat to fin stability**; **Issues: Blanket ban, Regulatory fragmentation across jurisdiction**; Can **follow IMF-FSB Synthesis Paper** for guidelines

#### Economic decoupling

- India can benefit from it & become global production hub
...
- (want our logistics to be as fast as cheetah) - **Elements**: Unified Logistics Interface (**not integrated, its interface**) Platform (ULIP); **Ease of logistics** service; **Integrated** Digital System (links 30 systems); **Multi-modal logistics** parks to be made;
...
- ⭐**Prime Minister** asked RBI to prepare a **10-year strategy to promote internationalisation** (This is a statement, not a question. No error, just noting the format.)
...
- **WF:** RBI WG (headed by **RADHA SHYAM RATHO**) Suggestions Short (**incentivising exporters** to accept indian currency, **synchronising tax regimes**) Long (RBI suggestion to **include in SDR**, will **need full capital ac convertability**); **Develop SoP** for it
...
- **5 years**; **Success** (Reduced rate arbitrage, 1.55 lcr monthly; 1.4 cr payers**, Formalisation of economy, Tech usage-E-Invoicing, Logistical eff-E-Way Bills**); **Failures** (**5 products still out;** SC said GST council holds persuasive values; Tax and cess usage; delay in compensation cess payment; **Fake ITC claims**; Compliances issue for small; GSTAT); **CAG Report - GSTN poor backend mgmt; WF**: **Data triangulation** to boost revenue; Reach out to Tier 2-3 cities as growing imp
...
- GOVERNMENT BUDGET (2023-24)
    ...
    - Fiscal Deficit: **5.9%, now 5.6%**
        - **Target 4.5% by FY26**; FRBM Targets also given by **NK Singh** (60% GDP for total debt)
...
- LABOUR FORCE
    ...
    - **Skilled workforce: 4.7% (vs 96% South Korea) = Total 101%** ⭐ (This sum is logically incorrect. If 4.7% has formal training, 95.3% does not. The sum cannot be 101%.)
- **INCLUSIVE GROWTH**
...
- AGRICULTURE
    ...
    - India is the largest producer of 🥛 milk & millets (M Factor 🆒) and second largest producer of rice, wheat, sugarcane and fruits & vegetables. India is the largest exporter of rice and second largest exporter of beef & cotton
    - Quote 2nd largest fruits/veg in Horticulture Question
    - India is the **largest producer of millet as of 2021,** with a total share of 41%
    - FPI: Annual growth rate 9%
    - Wastage of food item from farm to fork/consumer: 25%
- ENERGY & INFRASTRUCTURE
    - India has improved in the **logistics ranking** of the World Bank by **jumping 6 places to Rank 38** out of 139 countries in **2023**
...
- Steps by India: 6% on adv services by Non-resident digital cos; 2% on foreign e-commerce cos above 2 crore
...
- Issues: **USTR announced retaliatory tariffs**; Lack of consensus (**developed world wants sovereign commitments to not introduce any future digital services which India denied**); India currently gets approx. Rs 4,000 cr. in tax revenues through Equalisation Levy, which will be forgone after implementation of pillar one of BEPS 2.0
    ...
    - Pillar **Two** aims to get a level playing field across jurisdictions by **ensuring a Global Minimum Tax (GMT)**
- WF: Need **Global coordination G20** also aiming also aiming for a deal

### Miscellaneous Points

- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 22.jpeg]]
...
- ![[Z9 Obsidian-files/Media/DOCX/GS3 EconomicDevelopment 23.jpeg]]
