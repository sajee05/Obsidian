...
- **Why something is done ?**
    - Highlight the significance and it's application
...
5.  Transmutation
### Childs Rights
- **SPPD** - SP Purshottam Deshmukh बच्चों के राइट्स insure करते है।
1.  Survival
2.  Protection
3.  Participation
4.  Development
### HELM
- Indian Society and Caste System
    - Hierarchy
    - Endogamy
    - Division of Labour
    - Restricted Mobility
...
- this has application in way forward for society questions
    - Social
...
- **MAARG**
    ...
    - Growth
### Secularism 22
1.  Principled distance / Mutual Exclusion
2.  Community rights
3.  Minority rights
...
### Direct Democracy
1.  Referendum - voting on a single question (like Brexit)
...
- Education
### Judicial system
1.  Due process of law/procedure established by law.
...
### Panchsheel
- **AEITP** (आज एक बार IT पर प्यार आया है)
...
![[Z9 Obsidian-files/Media/DOCX/Frameworks.jpeg]]
- **FRESH**
    - Formal
    - Rational
    - Expertise
...
### Climate Action
### FRED-E
![[Z9 Obsidian-files/Media/DOCX/Frameworks 1.jpeg]]
- Quit Fossil Fuels - F
...
- Where the overall impact exceed the sum total of each part.
- **EPIC-WTF**
    - Energy shortages
    - Pandemics
    - Inflation
...
- **Impact assessment**
    ...
    - Health
- **MEASURES -**
    - पानी की क़िल्लत है गांधीसगर में DAM पर से CAP RARELY खोली जाती है
    - Preemptive - **DAM**
        1.  Data analysis
        2.  Risk Assessment
...
### Skill Development
- Rural and Related activities - 60% rural population
- Online Learning
- Skill on wheels
- Funding
    - CSR
...
- According to Goleman - 5 Components **ARMES**
    1.  Self Awareness
    2.  Self Regulation
...
- **I-O-SHOLA** (Input-output Shola - शोले का जवाब शोले से दिया जायेगा)
    - Integrity
    - Objectivity
    - Selflessness
    - Honesty
...
- **SPICE**
    ...
    - Cultural
    - Economic
        ![[Z9 Obsidian-files/Media/DOCX/Frameworks.png]]
...
- **Four pronged strategy to deal with China**
    - **DCEB** (DC में एक बड़ा neta है - TRUMP)
    - Deterrence
    - Collaboration
    - Engagement
    - Balancing
...
- **Values of Partnership**
    - **PR MDH**
        ![[Z9 Obsidian-files/Media/DOCX/Frameworks 2.jpeg]]
    - Democracy
    - Multicultural
    - Pluralist
    - Rule of law
