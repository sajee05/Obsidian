...
*   **3 types**
    ...
    *   **Inverted yield curve** - long term yield is lower then short term
        ...
        *   अभी बहुत हो गई
    *   **Flat** - बराबर
*   *(Diagram shows three types of yield curves against time to maturity: a normal upward-sloping curve, a flat curve, and an inverted downward-sloping curve.)*
...
*   **Effect of inflation on Borrowers and depositors**
    ...
    *   Therefore when there is a high rate of inflation the real interest earned by the lender/creditor(लेन्दार - बैंक) decreases as inflation eat away. visa versa a high rate of inflation benefits the borrower/debtor(देनदार).
...
*   **Mo** - Called high powered money. Or monetary base
    ...
    *   It also includes the commercial bank deposits held in the central bank's reserves.
    *   It also include the vault cash of commercial base.
*   *(Diagram shows that Monetary Base consists of Bank Reserves and Currency in Circulation. Money Supply consists of Currency in Circulation and Checkable Bank Deposits.)*
...
*   **MO** = Initial money created by RBI.
*   From this money, the banking system creates more money, which is denoted as M1, M2, M3, and M4
...
| :--- | :--- |
| Gold reserves | Cash in circulation. |
| Foreign exchange reserves | Deposits with RBI - of Banks, Central and State Governments. |
| Foreign government bonds | Loans that are taken by RBI |
| Indian government bonds | |
| Lending by RBI to Banks, Central and State Governments. | |
...
### High Powered Money- MO
*   It refers to the money created by RBI.
*   Sometimes MO is also referred to as the total liability of the central bank of the country.
...
*   We say that the initial high-powered money, MO has been multiplied by some number greater than one to create the actual amount of money supply, M1.
*   **M1= m* M0**, where M1= Money supply.
    *   m = Money multiplier
    *   MO = High Powered money.
...
*   **Bail in**
    *   **Bail-In:** Relief to a financial institution on the brink of failure by requiring the cancellation of debts owed to creditors and depositors.
*   **Bail out**
...
*   **Call and notice money**
    ...
    *   **CALL AND NOTICE MONEY:** Call money refers to day to day fund requirements of banks. When a bank faces cash crunch it borrow from other bank that has surplus and excess funds. For a period of 1 to 14 days. When money is lent for 1 day or overnight basis it is known a call money and when the period extends from 2 to 14 days it is termed as notice money.
...
| :--- | :--- | :--- | :--- | :--- |
| High | Low | Reduce money supply to reduce aggregate demand. | Growth cools down and prices also come down. | contractionary policy (that is reduce the money supply) or hawkish stance (money supply may be further tightened in the future). |
| Low | Low | Increases money supply to increase aggregate demand. | Growth is expected to increase and so are the prices. The money supply is increased to a level that prices don't go beyond tolerance but growth increases. | It is called Expansionary monetary policy. The stance is referred to as a dovish stance. |
| High | High | Maintain status quo. | | Neutral monetary policy |
| Low(recession and high unemployment) (stagflation) | High | Monetary policy is difficult to achieve desirable growth. Monetary policy becomes largely ineffective. | If the money supply is increased expect the growth to pick up and also take steps to control prices. If the money supply decreases, usually not followed as unemployment may rise. | unconventional monetary policy with either a dovish or hawkish stance with a bias toward dovish. |
| | | Decisions are taken on a case-to-case basis. | Supply-side measures are followed especially to control prices. | |
...
*   **Structure of Co-operative Credit Institutions**
    *   **Co-operative Credit Institutions**
        *   **Urban Co-operative Banks (1,853)**
            *   Scheduled UCBs (55)
            *   Non-Scheduled UCBs (1,798)
                *   Multi-State (10)
                *   Operating in Single State (1,788)
        *   **Rural Co-operative Credit Institutions (1,09,924)**
            *   **Short-Term (1,09,177)**
                *   State Co-operative Banks (31)
                *   District Central Co-operative Banks (367)
                *   Primary Agricultural Credit Societies (1,08,779)
            *   **Long-Term (747)**
                *   SCARDBS (20)
                *   PCARDBS (727)
...
#### Total Capital Requirement Under Basel III

| Capital Component | Requirement (as % of RWA) |
| :--- | :--- |
| **Tier 1 Capital (Core Capital)** | **6%** |
...
| Assets Classification | Period as NPA | Provision |
| :--- | :--- | :--- |
| **Standard** | | Agriculture and SME: 0.25%; Commercial Real Estate (CRE): 1%; Commercial Real Estate-Residential Housing Sector (CRE-RH): 0.75%; Housing loan: 2% after 1 year: 0.40%; All other: 0.40% |
| **Substandard (Secured Loan)** | Up to 1 Year | 15% |
| **Substandard (Unsecured Loan)** | Up to 1 Year | 25% |
| **Doubtful 1** | 2nd year | 20% (Infrastructure Loan); 25% (Secured Loan); 100% (Unsecured Loan) |
| **Doubtful 2** | 3rd & 4th year | 40% (Secured Loan); 100% (Unsecured Loan) |
| **Doubtful 3** | 5th year onward | 100% |
| **Lost assets** | | 100% |
...
| Basis For Difference | Gross NPA | Net NPA |
| :--- | :--- | :--- |
| **Meaning** | Sum of loans Defaulted | Default Loans – Provision for Default |
| **Default Period** | Ninety Days | Immediately |
| **Actual Loss** | Not Actual Loss | It is the Actual Loss |
| **Causes** | Poor government policies, industrial sickness, natural calamities etc. | Low Provision for Unpaid Debts |
| **Effects** | Equity and Company Goodwill | Profitability and Liquidity |
...
*   **Recognize, Resolve, Recapitalize, Reform**
    ...
    *   **Insolvency and Bankruptcy Code, 2017**
        ...
        *   **Issue**
            ...
            *   *(Graph shows that resolution time in days for large NPAs (above 1000 crore) has been increasing from FY18 to FY22, extending well beyond the stipulated time.)*
    *   **Recapitalization of banks**
        ...
        *   These are
            *   **Selling of equities** - the owner e.g. the govt may sell its equity in the bank and then used the money collected and infuse it in the bank as capital. However, selling equity poses political difficulty due to concerns of privatization.
            *   Further, if govt's shareholding falls below 50%, there may be a chance of a hostile takeover. Also, the valuation at which equity is sold is also debatable and therefore may lead to allegations regarding selling govt assets at a less than their fair value.
            ...
            *   **Via Recapitalization Bonds** - Even though banks are under-capitalized, they can still lend to the govt without any strain or additional requirement of capital. Since the govt is deemed as a zero risk entity, lending to govt does not add to a bank's risk-weighted assets or create any provisioning requirements. Govt borrows from banks by issuing recap bonds. The govt receives this borrowed money and then by virtue of being the owner, infuses this money back into the banks in form of capital. This way a bank's deposits (liability) are returned to the bank via the govt as capital.
                *   \*borrowing via Recap bonds increases the total borrowing of the govt and therefore, its public debt increases.
                *   The ability of govt to borrow more for its own purposes thus reduces. This is the risk or cost that the govt bears to recapitalize banks.
...
*   *(Diagram shows the transactional flow for a non-bank payment aggregator (PA), involving the Payer, PA, Payer's Bank, PA's Partner Bank, Merchant's Bank, Merchant, and NPCI for authorization.)*
*   **Payment gateway** acts as a secure bridge that verifies and transmits payment information safely but doesn't hold any money itself. E.g. Razor pay, PayPal
...
*   *(Diagram shows Government Budget is split into Revenue Budget and Capital Budget. Revenue Budget is split into Revenue Receipts (Tax and Non-tax) and Revenue Expenditure (Plan and Non-plan). Capital Budget is split into Capital Receipts and Capital Expenditure (Plan and Non-plan).)*
*   **Revenue Account**
    *   **Revenue Expenses**
...
*   *(Diagram shows the Rahn Curve, an inverted U-shape, plotting Economic Performance against Government spending % of GDP. It suggests an optimum size of government for maximizing economic performance.)*
...
| :--- | :--- | :--- |
| **Fiscal Policy** | | |
| **Pro-Cyclical** | Expenditure increases, Tax decreases | Expenditure decreases, Tax increases |
| **Counter Cyclical** | Expenditure decreases, Tax increases | Expenditure increases, Tax decreases |
...
*   *(Diagram shows the Laffer Curve, an inverted U-shape, plotting Tax Revenue against Tax Rate. It indicates that tax revenue is zero at 0% and 100% tax rates and is maximized at some point in between.)*
...
*   **Differences between tax buoyancy and tax elasticity**
    *   Tax buoyancy is the most appropriate measure when assessing the impact of tax policy and tax administration changes on tax revenue.
...
*   *(Diagram shows a virtuous cycle: Income/Consumption leads to Savings, which leads to Investment, which leads to Production, which in turn increases Income/Consumption.)*
