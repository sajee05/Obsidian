...
- All ![[media]] references in their exact original locations
...
2. **Format Application:** Apply markdown structure while preserving exact content
3. **Content Verification:** Ensure no text changes, only structural formatting
4. **Final Review:** Confirm structural changes only, content unchanged
...
- ONLY apply structural markdown formatting
