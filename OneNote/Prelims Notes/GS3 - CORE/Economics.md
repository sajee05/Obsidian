...
![DIMENSIONS Long and healthy life Knowledge A decen...](Obsidian-files/Media/Exported%20image%2020250604061950-0.png)
...
- ![DIMENSIONS Education Standard of living INDICATORS...](Obsidian-files/Media/Exported%20image%2020250604061955-1.png)
...
- ==India is now a low-middle-income country==, at its income level, the ==p==overty line is 3.2 dollars/ person/da==y==, whereas the official poverty line is still coincidentally, close to 1.9 dollars/person/day.
...
- Okun's law: states relationship between ==unemployment and GDP== ==growth==, it predicts that ==1% rise in unemployment== will usually be associated with ==2% drop in GDP==.
    ...
    - ![Okuns law Wikipedia](Obsidian-files/Media/Exported%20image%2020250604061957-2.png)
...
- ![Lorenz Curve and Gini Coefficient Drishti IAS](Obsidian-files/Media/Exported%20image%2020250604061959-3.jpeg)
...
- ![On the Origins of the Kuznets Curve A Budding Soci...](Obsidian-files/Media/Exported%20image%2020250604062001-4.png)
...
![DIMENSIONS INDICATORS DIMENSION INDEX Health Mater...](Obsidian-files/Media/Exported%20image%2020250604062003-5.png)
...
- **Classical unemployment**
    ...
    - ![Classical Unemployment Definition Economics Help](Obsidian-files/Media/Exported%20image%2020250604062005-6.png)
...
- ![Production Possibility Frontier Economics tutor2u](Obsidian-files/Media/Exported%20image%2020250604062006-7.png)
...
- ![Opportunity Cost Formula Calculation and What It C...](Obsidian-files/Media/Exported%20image%2020250604062011-8.png)
...
- ![The optimal consumption rates of necessity and lux...](Obsidian-files/Media/Exported%20image%2020250604062013-9.png)
- ![Income Effect Income Consumption Curve with curve ...](Obsidian-files/Media/Exported%20image%2020250604062015-10.png)
...
- ![81 Public Goods Social Sci LibreTexts](Obsidian-files/Media/Exported%20image%2020250604062017-11.jpeg)
...
- ![The Circular Flow Diagram UBC Wiki](Obsidian-files/Media/Exported%20image%2020250604062018-12.jpeg)  
...
- **Incremental Capital Output Ratio(ICOR)**
    ...
    - ![Incremental Capital Output Ratio ICOR Definition a...](Obsidian-files/Media/Exported%20image%2020250604062020-13.png)
    ...
    - ![NFIA GDP GNP NNP at Market Price ID Sub NNP at UP ...](Obsidian-files/Media/Exported%20image%2020250604062022-14.png)
...
1. From the sample's output information value of output is calculated.
...
- **3****rd** **phase (near-vertical slope)**
    ...
    ![Solved State all the appropriate fiscal and Cheggc...](Obsidian-files/Media/Exported%20image%2020250604062026-15.png)- ![The four phases of an economic cycle Phase 2 Ptme ...](Obsidian-files/Media/Exported%20image%2020250604062028-16.png)
...
- ![Phillips Curve Definition Importance Philips Curve...](Obsidian-files/Media/Exported%20image%2020250604062030-17.png)
    ...
    - 3 types
        ...
        - Inverted yield curve - long term yield is lower then short term
            ...
            - Investors expects the interest rates(yields) to decrease in future
                ...
                - अभी बहुत हो गई
        - Flat - बराबर
        - ![Yield Curve Basics How to Read the Bond Market Bri...](Obsidian-files/Media/Exported%20image%2020250604062031-18.jpeg)
          
        
- **Spiral inflation -** when inflation is increasing continuously and there is no control over it.
- **Goldilocks economy**
    
    - ![A Goldilocks economy is thus warm enough with stea...](Obsidian-files/Media/Exported%20image%2020250604062033-19.png)
...
- **Speculative Demand for Money**:
    ...
    - It can be illustrated in the following way:
        ...
        - Out of M-T:
            ...
            - To keep ==liquid (L) = Speculative demand for mone==y
...
- Therefore, deciding how much money should be printed and circulated is a decision that has contrasting effects on two desirable goals i.e.
    ...
    - While it facilitates growth, it also causes inflation #remember-for-later
  ...
  - Mo - Called ==high powered money==. Or ==monetary base==
    ...
    - ![What is Money Supply Definition and Concept Explai...](Obsidian-files/Media/Exported%20image%2020250604062034-20.png)
...
- **Call and notice money**
    ...
    - ![Call Money](Obsidian-files/Media/Exported%20image%2020250604062036-21.jpeg)
...
- It saw the large-scale movement of capital from developing countries to safe-haven assets in developed nations and caused currency fluctuations in many countries including India.
 - The **Cantillon effect** ==refer==s to the idea that changes in the money supply in an ==economy causes redistribution of purchasing power among people==, disturbs the relative prices of goods and services, and leads to the misallocation of scarce resources.       
...
- **Differentiated Banks**- They only perform specific functions of the banks. Some major examples are:
    ...
    - Cooperative Banks:
        ...
        - They are initiall==y registered under the Registrar of Cooperative Societies of the respective states.==
        ...
        - ![Cooperative Banking in India](Obsidian-files/Media/Exported%20image%2020250604062041-22.jpeg)
...
- Financial inclusion refers to making basic financial products and services readily available and accessible to all individuals and businesses, regardless of their income level, background, or location. - Financial inclusion is commonly understood in the terms of opening a bank account.
...
- **Priority Sector Lending (PSL)** (refer to the qualitative tools of monetary policy)
    ...
    - Priority sector lending (PSL) is a regulatory requirement for scheduled commercial banks in India to ==allocate a specific por==tion of their credit to certain sectors considered critical for socio-economic development.
...
- **MCLR (Marginal Cost of Funds based Lending Rate)**
    ...
    - The borrowing which is undertaken with the intent to further relend is called a==s financial borrowing.== For e.g. Banks, NBFC etc.
...
- **External Benchmarking** - To ease compliance with MCLR, RBI introduced external benchmarking. 
    ...
    - For example, it consists of ==repo rate, MIBOR, the yield on 10-year govt security, e==tc. which can be included as the variable cost in the MCLR formula.
    ...
    - ==It is mandatory for banks and recommendary for NBFC by the RBI.== #remember-for-later
...
- **Narasimhan Committee** recommended a three-tier bank structure - 
    ...
    - There should be ==2-3 Large bank==s that are globally competitive.
    - There should be ==8-10 banks at the regional level.==
    - There should be ==20-25 banks to cater at the local level p==rimarily to the retail segment.
...
- BCBS works under the aegis of th==e== Bank of International Settlement located at Basel, Switzerland.
...
- Total Capital Requirement Under Basel III ⚖️
    ...
    - ![Capital Component Tier 1 Capital Core Capital Comm...](Obsidian-files/Media/Exported%20image%2020250604062043-23.png)
- Additional Basel III Requirements 📜 - Basic Meaning
...
- Booking a provision means th==at the bank recognises a loss on the loan ahead of time== and set aside a proportion of capital to absorb these losses from it's own funds.
- Provisioning requirements ensure that in case the asset becomes an ==NPA== i.e. the loan is not returned, the banks have their own money from which they can repay the depositors, whose money was lent.
    ...
    - ![CAIIB BFM Module D Asset Classification and Provis...](Obsidian-files/Media/Exported%20image%2020250604062045-24.png)
    - Lost assets - loss has been identified either by banks or externally (auditors/RBI etc.) but has not been written off.
- ==Provisioning coverage ratio - ratio of provisioning to gross NPA.== #remember-for-later 
...
- This is implemented through CRAR or CAR.
    ...
    - ==CRAR - Capital to Risk-Weighted Assets Ratio, aka CAR - Capital Adequacy Ratio== #remember-for-later
        
        - It is the ratio of bank's capital in relation to it's risk weighted assets and current liabilities.
        - ==Banks are required to maintain at least 9% of their risk-weighted asset as capital at all times. (Basel 3 norm is 8%, whereas, RBI has mandated 9%)== #remember-for-later #remember-for-later
        - ==Over and above this 9%, banks also have to maintain a CCB (Capital Conservation Buffer) of 2% or their RWA(risk weighted assets) as capital.== #remember-for-later
...
- **Twin Balance Sheet Syndrome'** (TBS) is a scenario where ==banks are under severe stress== due to: High levels of non-performing assets (==NPAs==), high provision requirements, low profits, low capital adequacy ratios (CAR). And ==corporates are overleverage==d to the extent that they might not be able to repay their loans.
    ...
    - **Solution ?**
        ...
        - Economic Revival - Writing off an asset -
...
- Special Mention Account (==SMA==) -
    ...
    - Net NPA = Gross NPA - provisioning for default #remember-for-later
        
        - ![Gross NPA VERSUS Net NPA](Obsidian-files/Media/Exported%20image%2020250604062046-25.jpeg)
...
- **Recognize, Resolve, Recapitalize, Reform**
    ...
    - **Resolve**
        ...
        - Resolution is a process that consists of ==recovering whatever i==s due to the banks and also involves the banks taking some losses in the process(==haircut==).
...
- **SARFAESI Act,** **2002**
    ...
    - ==*Only for secured loans, not applicable to agricultural loans.== #remember-for-later
...
- **Insolvency and Bankruptcy Code, 2017**
    ...
    - **When the IBC process is initiated -**
        ...
        - If there is no such plan accepted by CoC, a==ssets will be liquidated to the extent the payment has to be done==.
        ...
        - ##### Issue
            ...
            - ![Days 200 Less than 50 crore 50100 crore 100500 cro...](Obsidian-files/Media/Exported%20image%2020250604062048-26.png) - **Recapitalization of banks**
    ...
    - These are -
        ...
        - **Via Recapitalization Bonds** - Even though banks are under-capitalized, they can still lend to the govt without any strain or additional requirement of capital. Since the govt is deemed as a zero risk entity, lending to govt does not add to a bank’s risk-weighted assets or create any provisioning requirements. ==Govt borrows from banks by issuing recap bonds.== The govt receives this borrowed money and then by virtue of being the owner, infuses this money back into the banks in form of capital. This way a bank's deposits (liability) are returned to the bank via the govt as capital.
            ...
            - *borrowing via Recap bonds increases the total borrowing of the govt and therefore, its public debt increases. ==The ability of govt to borrow more for its own purposes thus reduce==s. This is the risk or cost that the govt bears to recapitalize banks.
            - ==*Borrowing under this scheme is outside the limits prescribed under the FRBM Act.== #remember-for-later
...
- **Reform of banking system**
    ...
    - Under **Mission Indradhanush** ==it== is proposed to set up a separat==e== **BHC (Bank Holding Company)** - a special company that will be set up to hold govt shareholding in the PSBs i.e. one more entity between the owner and the bank.
...
- ![4 Authorisation Request qesvo ayers Bank 7 Receive...](Obsidian-files/Media/Exported%20image%2020250604062050-27.png)
...
- **Various Techniques of Govt Budgeting**
    ...
    - **Line Item Budgeting**
        ...
        - Simply presenting the ==items of expenditure. Mai==ntain a list of items on which expense has been incurred. Pure accountancy concept. Does not convey much information about the objectives and their achievements. E.g. For Health Department 10Cr layout for vaccination of children under 5.
    ...
    - **Outcome Budgeting** #important
        
        - ==More than efficiency and output, outcomes are analysed==- Does the expenditure achieve the ==ultimate objective for which it was laid ou==t? E.g. Vaccination received approval for expenditure to reduce child mortality. Did mortality of children come down after vaccination?
    - **Zero Based Budgeting**
        
        - Analysing every expenditur==e from the base every yea==r. Just because some schemes got allocation in a previous year does not mean that it will be continued and allocated new expenditure in the subsequent year. It needs to be reanalysed every year afresh on its performance.
    ...
    - ![Government Budget Revenue Budget Revenue Receipts ...](Obsidian-files/Media/Exported%20image%2020250604062051-28.png)
        - **Revenue Account**
    ...
    - **Capital Receipts**
        ...
        - We classify capital receipts into two parts -
            ...
            - ==Debt creating Capital Receipt==s - which creates debt/liability.
    ...
    - **Plan & Non-planned classification**
        ...
        - **Rangarajan Committee, 2012****,**  recommended doing away with this approach.
            ...
            - The recommendation was ==implemented in 2015 a==nd since then this ==practice has been stopped.==
...
**Types of deficits** #important
 - **On the basis of financing**
    ...
    - Monetised deficit
        ...
        - ==That part of the budget deficit that is monetized by printing currency is called a monetized deficit.== #remember-for-later
        ...
        - The budget thus became a tool of political popularism through promises of expenses without actually having the money to spend. - **Ways and Means Advance**
    ...
    - Under this RBI would provide t==emporary loans to the government== so that it could deal over any temporary mismatches in liquidity.
    ...
    - Normal WMA - clean advance - no collateral. #remember-for-later
    - ==Special WMA== - against the collateral of the government #remember-for-later
    - A similar facility was provided to the state as well under which ==RBI gives== SDL (State Development Loan) to the states. - **On the basis of the type of transaction**
    ...
    - **Net fiscal deficit:** Net Fiscal deficit is equal to GFD minus loans given by the government.￼ #important
    - **Primary deficit (PD) = FD - Interest Payment**
        ...
        - In this debt, the government has to pay interest.
            ...
            - Interest cost on autonomous interest that is it is ==not discretionary for the government t==o not pay interest.==(charged on CFI),== i.e. they are charged on consolidated fund of India
    ...
    - **Revenue Deficit: RD = RE - RR**
        ...
        - It came up with the ==c==oncept of effective revenue defici==t== to replace the target for revenue deficit in FRBM Act.
    ...
    - **Effective Revenue Deficit(ERD) = Revenue Deficit -** **Transfers to state or creation of capital assets.**
        ...
        - **Similarly, Effective Capital Expenditure** = Capital Expenditure by Central Govt. + Grants given to states for creation of capital assets. #remember-for-later
    ...
    - The Committee suggested that a ==r==ule-based fiscal policy by limiting government debt, fiscal deficit, and revenue deficits to certain targets is good for fiscal consolidation in India.
    - **Th****e public debt to GDP ratio** **should be considered as a medium-term anchor for fiscal policy in India.** The combined debt-to-GDP ratio of the centre and states should be brought down to 60 percent by 2023 (comprising of 40 percent for the Centre and 20% for states) as against the existing 49.4 percent, and 21 percent's respectively.
    ...
    - **Revenue deficit target:** The Committee also recommends that the central government should reduce its revenue deficit steadily by 0.25 percentage (of GDP) points each year, to reach 0.8% by 2023, from a projected value of 2.3% in 2017.
        ...
        - ==The Committee advised the government to follow the golden rule here i.e.,== not to finance the government’s day-to-day expenditure through borrowings. #remember-for-later
    ...
    - **Formation of Fiscal Council to advise the government.** The Committee advocated the formation of institutions to ensure fiscal prudence in accordance with the FRBM spirit.
        ...
        - It r==ecommended setting up an independent Fiscal Council.==
    ...
    - **Composition of Expenditure**
        ...
        - **Central Sector Schemes**
            ...
            - ==They are the schemes that are entirely and directly funded and executed by the central government.== #remember-for-later
            ...
            - ==In these schemes, the financial resources are not shifted to states.== #remember-for-later
        ...
        - **Central Sponsored Schemes (CSS)**
            ...
            - However, the cost of these schemes is borne on a shared basis in the ratio of ==50:50, 70:30, 75:25, or 90:10==. Under the cost rati==o,== the larger portion is always borne by the Centre.
...
- **Other liabilities** - money that ==government holds as a trustee e.g. PF account deposits.==
    ...
    - ==Treasury bills do not pay any interest.== #remember-for-later
...
- **Public debt** refers to money borrowed by the government.
    ...
    - ==G-Sec(government dated securities), T-Bill, External Assistance, Short term borrowings comprises of public debt.== #remember-for-later
    ...
    - **Other liabilities** - these are monies held by the government as a  trustee.
        ...
        - ==The government's external debt is called external public debt or sometimes sovereign debt.== #remember-for-later
        - ==Whereas the external debt of the country as a whole is called external debt.== #remember-for-later

- As such external public debt is just one component of external debt.
- Other components include Borrowings b==y private an==d other non-government entities from foreign sources, such as ==external commercial bonds or borrowing (ECB),== bonds issued in a foreign market - foreign currency or domestic currency denominated. - **External public debt** - consist of ==borrowing by the government from non-resident==s, such as from FII which purchase government bonds, multilateral and other agencies like the world bank and IMF, foreign countries etc.
...
- ![Rahn Curve Economic Performan e Optirrjam size o v...](Obsidian-files/Media/Exported%20image%2020250604062057-29.png)
 
- **Government's role in stabilizing the business cycle**
    
    - ![Business Cycle Fiscal Poli ProCyclical Counter Cyc...](Obsidian-files/Media/Exported%20image%2020250604062058-30.png) - **Crowding in and crowing out**
    ...
    - The ==crowding out== effect is an economic theory that argues tha==t rising public sector spending== drives down or even ==eliminates private sector spending==. This is due to ==increased cost of borrowing== as government borrows money increasing the cost of capital.
...
- **Taxes on the basis of distributive features -**
    ...
    - **A proportional tax** - A proportional tax is an income tax system that levies the s==ame percentage tax to everyone== regardless of income.
        
        - **Russia:** Russia has a flat income tax rat==e of 13%.==
        - Self-employed persons pay 4-6% on turnover.
          
        
    - **A regressive tax** - A regressive tax is a ==tax taking a larger percentage of income from low-income earner==s than from high-income earners.
...
- **Direct taxes**
    ...
    - **Tobin tax -** tax levied on s==pot currency conversion==s or short term currency transaction, in order ==to disincentivise speculation== and reduce volatility.
...
- **Indirect taxes -**
    ...
    - **Central sales tax** - ==interstate== sale of goods.
        ...
        - Levied by c==entre but given entirely to states.==
...
- ==It helps us to explain tax buoyancy and tax elasticity.== #remember-for-later
...
- ![Laffer Curve Indian Economy Notes](Obsidian-files/Media/Exported%20image%2020250604062100-31.png) 
...
- ![Training course in revenue forecasting](Obsidian-files/Media/Exported%20image%2020250604062102-32.jpeg)
...
- To avoid this BEPS governments or tax authorities sign the **Advance Pricing Agreement** ==i==n which the firms agree to have pricing policies that will be fair.
...
![The Death Of The Virtuous Cycle Seeking Alpha](Obsidian-files/Media/Exported%20image%2020250604062103-33.png)- For **capital formation** ==saving is necessar==y. If the savings are higher it will result in higher capital formation and more income with more savings and that is called a **virtuous cycle** of growth. But what if there are no savings, there will not be capital formation and one will remain in a trap that is called a **low income or poverty trap.** - Gr==oss fixed capital formation (GFCF), also known as invest==ment, reflects the value of newly acquired fixed assets by businesses, governments, and households within an economy during a specific period (usually a year).
...
- **A promissory note** is where one party requests the other to give loans or to delay the process of repayment. In the case of the promissory note, the bearer is not accepted as per RBI.
    ...
    - A promissory note is a ==written promise==, whereas a bill of exchange is a ==unconditional written order==. The promissory note allows no copies, whereas a bill of exchange can have multiple copies. Two or more parties can be involved in a bill of exchange, but a promissory note only involves two parties. - **Bonds and securities**
    
    - A bond is a debt instrument issued by governments or corporates to raise loans over a given period of time.
    - If a bond is well received and ==trusted== among the investors, it can be called a **Gilt bond** ==an==d if the investors are ==sceptic== about bond , it can be called a **junk bond**==.==
...
- **Bonds of money market (****CT****)**
    ...
    - In the money market they are issued for a time span of ==less than a yea==r in the following ways:
    ...
    - In 2010, for ==less than 91 days== **C****ash Management Bills(CMBs**==)== have been introduced which are issued at a discount on face value. (Earlier there used to be 14 days ad-hoc treasury bills also, but they are discontinued now since 1997) to meet the temporary cash flow of the government, they are issued by Central government.
      
    - **If issued by a Company, they are called** **commercial pape****r**. As these commercial papers are ==non secured(wi==thout any guarantee), the credit rating needs to be very good of the issuer.
        
        - Issued for ==up to 1 yr. to co==ver short term receivables and meet short term financial obligations.
        - They are issued in denominations of 5 lakhs.
            
            - रिटेल निवेशकों की औक़ात के बाहर है

- **If it is issued by banks, it is called a** **certificate of deposits**==.== However, some other financial institutions can issue certificates of deposits fo==r up to 3 years.==
...
- **Debt instruments in** **capital market**
    ...
    - If issued by the central government called **D****ated securities.**
...
- G-secs issued by a government are managed by RBI, be it central govt or SDL.
    ...
    - ==For this purpose, RBI uses NDSOM (Negotiated dealing system order matching) and Clearing Corporation of India CCI works as depository participant and clearinghouse.== #remember-for-later
...
- Recently in a very revolutionary step this p==rimary security market has been opened to even retail investor==s (minimum investment is 10000).
...
- **Seeking investment**
    ...
    - In this whatsoever is the market capital expected is equated in ==common denomination legal documents to be called as share==s
...
- **Red Herring prospectus.**
    ...
    - In which the company hires an ==underwriter/investment banke==r who is a legal consultant to provide all consultancies regarding how much of the values should be shared, price of shares, and what the red herring prospectus should look like.
...
- Generally, the range between floor and cap is 20 %.
    ...
    - **based on** responses from the public the ==cut-off price is decided o==n which the IPO will be given and once IPO is allotted now the concerned buyer may sell it on the stock market (secondary market)
- At wha==t price the secondary market starts is the listed price.==
    
    - ==After the Roopal Panchal case, the stag investors (investors without advance money) are not allowed.== #remember-for-later
...
- **Exchange-traded funds (ETF)**
    ...
    - It’s considered to be one of the ==safest options because the risk is calculated a==s it's highly unlikely that all companies will stop performing.
...
- **Alternate investment funds** #important
    
    - Privately pooled Investment funds that infuse in hedge funds, private equity, venture capital, and other investment types.
    - Generally the==y target HNI, but== growingly they are targeting mid sized retail investors.
    ...
    - Category 3: - Private Investment in Public Equity Fund (PEF), Hedge funds - **Surety bonds**
    ...
    ![What is a Surety Bond Surety Bonds Explained](Obsidian-files/Media/Exported%20image%2020250604062105-34.png)- 4 types of surety bonds in general
        ...
        2. **Performance Bond:** Provides an ==owner with a guarantee== that, in the event of a ==contractor’s defaul==t, the ==surety will complete== or cause to be completed ==the contract==.
        3. **Payment Bond:** Ensures that certain ==subcontractors and suppliers will be paid f==or labour and materials incorporated into a construction contract.
...
- **Various types of Investors**
    ...
    - **Qualified institutional Buyers (QIBs)**
        ...
        - They are the big investors acknowledged and ==listed by SEB==I. Could be individuals or companies.
...
- The first recognized stock exchange, paving the way for modern stock markets, is generally considered to be the **Amsterdam Stock Exchange**, established in **1611**. - The stock exchange is the platform where primary and secondary market operates in the case of equities.
...
- In order to control the Bombay Stock Exchange as early as 1947, ==a Controller of Capital was iss==ued which used to regulate both debt and equity market.
...
- Additionally, SEBI is also a member of the Financial Stability and Development Council (FSDC) ==introduced in 2010 which is headed by the finance ministe==r. SEBI provides necessary inputs regarding financial stability. The RBI Governor is also its member
...
- In India BoP details are maintained by RBI and calculations are done in dollars - As per the BoP manuals, BoP is divided into the following two heads -
    ...
    1. **Current account -**
        ...
        2. Balance of Invisibles
            ...
            3. Remittances
        ![Balance of Payments Components of Balance of Payme...](Obsidian-files/Media/Exported%20image%2020250604062107-35.png)  
    ...
    2. **Capital Account -**
        ...
        2. Debt
        3. Banking capital
        ![Balance of Payments Components of Balance of Payme...](Obsidian-files/Media/Exported%20image%2020250604062111-36.png)  
...
- Sometimes additional demand also emerged in order to fill **strategic petroleum reservoirs(SPR)**
    ...
    - ![Strategic Petroleum Reserves Civilsdaily](Obsidian-files/Media/Exported%20image%2020250604062113-37.jpeg)
...
- As of 2025, India's top five imports and exports reflect its economic structure and trade dynamics. Here’s a detailed overview:
    ...
    5. **Rice**:
        ...
        - Significance: India is the largest exporter of rice globally, particularly basmati rice. - ![DATA STORY ExportImport of India 2021 GS SCORE](Obsidian-files/Media/Exported%20image%2020250604062115-38.jpeg) - ![MAP 1 Export hubs The data for the maps and the ta...](Obsidian-files/Media/Exported%20image%2020250604062117-39.png)
...
- ==The Export can be strengthened with== **more Trade agreements.** #remember-for-later - **Trade agreements:**
...
- **Some of the common trade agreements are -**
    ...
    - ![Free Trade Agreements FTA Examples FTAs of India U...](Obsidian-files/Media/Exported%20image%2020250604062118-40.png)
...
- On the Other Hand in International trade, **as per WTO trade in services** are subdivided into the following four categories. #important
...
- ==Most developing countries want Mode 1 and Mode 4 to be promoted== #remember-for-later
- ==Developed countries want Mode 2 and 3 to be promoted== #remember-for-later - In services, India is in surplus primarily due to the Software and BPO sector. The Maximum export destination is the USA. 
...
- The Safe Harbour rules provide certain relaxation in the tax by amending IT Act 1961 to attract those Indian Professionals who are operating from other countries like Singapore.
    ...
    - ![Safe Harbour Meaning Examples Types Provisions Rul...](Obsidian-files/Media/Exported%20image%2020250604062120-41.jpeg)
      
    
- In terms of Remittances since 2008 India **Rank 1 in Inflow.**  - The Current Account Position - To conclude it can be said that the overall Current Account is in Deficit (CAD). Balance of Trade is in Deficit while the Balance of Service is in Surplus.   
**Capital Account**

- ![Balance of Payments Components of Balance of Payme...](Obsidian-files/Media/Exported%20image%2020250604062121-42.png)
...
- **e. Convertible notes -** ==it refers to the instrument of investment of start-ups where initially it is in form of debt but has the option to get converted into shares.== #remember-for-later
...
- RBI very explicitly highlights that there are ==no other criteria to determine FDI or FPI other than the percentag==e. However, once FDI is always FDI.
...
- **In general, this FPI is viewed under the following heads:**
    ...
    - **2. Qualified Foreign Investment**
        ...
        - It was introduced in 2011 that if any foreign investor is c==oming from a country== who is a ==member of t==he **Financial Action Task Force(FATF)** or the **International Organisation of Security Commission(IOSC)** ==get quick clearance==s of investment.
...
- Based on data from Department of Economic Affairs (DEA)
    ...
    - Total external de==bt: US$ 554.8 billio==n
...
- In terms of banking Capital, it refers to the capital at the disposal of the bank (Net value) in form of various assets and Foreign Currency non-resident accounts (==FCNRA==), this ==FCNR== is divided into the following two - - **FCNR(A) =** was introduced in 1975 but discontinued in 1993 because in this the exchange change risk burden of foreign currency was with RBI. So if RBI promotes FCNR accounts in the same proportion exchange burden also increases. however, since 1993 We have **FCNR(B)** in which the exchange risk is with the banks. 
...
- ==It is very important to mention here that the exchange rate of currencies is the product of demand and availability and must not be confused with the strengths and weaknesses of the economy.== #remember-for-later
...
- **The exchange rate could be of the following 4 types -**
    ...
    - **3. Managed o****r Dirty Floating Exchange Ra****te =** it is wherein a g==iven bandwidth the currencies are allo==wed to have a floating exchange rate but the moment it is going beyond the threshold central bank intervenes to regulate it. India follows this model. for example, If RBI provides bandwidth of 60-80 that means 1 dollar is between 60 Rs to 80 Rs its fluctuations will be determined by the market but the moment it is going below 80 Rs or above 60 Rs RBI will intervene.
      
    - **4. Manipulative Exchange Rate =** it refers to those countries who ==deliberately manipulate their exchange rate== with the dollar ==to support export.== The USA maintains a list of these manipulators li==ke China, Hong Kong, et==c. along with another list of manipulation watchlists regarding potential manipulators.
 
- **Effective exchange rate (EER)**
    
    - The exchange rate of the rupee can gaze with ==major trading partner==s because at the end of the day effective fluctuation in the exchange value of those currencies with whom India is trading is significant.
    ...
    - Earlier th==e base year== was 2004-05 but now has been changed to ==2015-16.==
    ...
    - The REER takes the NEER a step further b==y adjusting it for inflation differe==nces between the home country and its trading partners.
    - A nation's nominal effective exchange rate (NEER), adjusted for inflation in the home country, equals its real effective exchange rate (REER).
        ...
        - To keep exports competitive RBI generally keep the REER \< 100. - **Market sterilization** #remember-for-later
...
- ==India is not a member of ICSID. It is a dispute resolution mechanism.== #remember-for-later
...
- Target: All member countries, with a focus on those facing balance of payments problems, high debt, or financial crises. - It came into existence in 1944 along with IBRD which is why they together are called twin organizations.
...
- **The fund and the quota:**
    ...
    - This Quota is decided on the basis of the following 4 parameters==:== #remember-for-later
        
        - 1. ==GDP== of the economy with ==50% of weightage== (60% market exchange rate, 40% PPP)
        - 2.  ==Openness== of the economy with ==30% weightag==e
        - 3. Economic ==viability== with ==15%== weightage  
        - 4. ==Forex== with ==5%== weightage 
        - ![IMF Quota 50 30](Obsidian-files/Media/Exported%20image%2020250604062126-43.png)
    ...
    - This can be done either by changing the formula of Quota allocation or reducing th==e consensus % below the existing 85%==
...
- Later on in 1986 at Uruguay Round, once again an attempt was made to develop an international organisation to facilitate World Trade and subsequently, in 1994, the Marrakesh Agreement has opened resulting in the ==formation of WTO.== - WTO consists of a General Council for routine policy-making and administrative functions 
- This consists of various representatives from the member countries and at the apex level, it holds Ministerial Conference where ministers from member countries me==et once in two year==s, popularly called as Ministerial conference 
- As of now, there are 164 members (Director General) of the WTO - On the other hand, there is a Dispute Resolution Body to take the disputes 
...
5. Agreement on Trade-Related Investment Measures (TRIMs): 7. **In terms of Tariff**
...
9. **Anti-dumping duty:**
    ...
    - This clearly indicates that the country is getting hostile and therefore to protect the interest of local manufacturers importing country can apply additional duty called as Anti-Dumping duty 11. **Countervailing duty:**
...
- **In terms of Agriculture**:
    ...
    - ![Green Box These measures are exempt from reduction...](Obsidian-files/Media/Exported%20image%2020250604062127-44.png)
...
- ==Mode 3-== exporters countries’ i==nstitutions going abroad to give services==. Also known as ==commercial presence==. E.g. DB in India
- ==Mode 4 -== international ==labour Movement.== Labour mobility (==Movement of natural persons==) - The above modes were discussed in the DOHA round of WTO.
...
- **Geographic Indication Tags.**
    ...
    - I==n WTO at DOHA 2002 disc==ussion on TRIPS compliance to be effective from 2005 but Developing countries demanded the TRIPS flexibilities (certain relaxation in cases of emergencies) example COVID-19 case.
...
- **National Infrastructure Pipeline**
    ...
    - **Funding structure:**
        ...
        - Almost 24% of the total investments will go into the energy sector. - **India Investment Grid** has been developed by the Ministry of Commerce and Industry to attract investments.
    
    - Additionally, Alternative Investment Fund(AIFs) and the reintroduction of DFIs will also ensure fund availability.
        
        - ==Registered under SEBI== #remember-for-later
...
- Financial Health of Distribution Companies (DISCOMs):
    ...
    - Ac==cumulated debt: Most DIS==COMs are burdened with high debt, hindering their ability to invest in network upgrades and improve efficiency.
...
- The major issue is transmission loss which is as high as **34%.** #remember-for-later
...
- **The major challenges of the Indian railway today can be summed up as follows****:**
    ...
    1. Not up to the mark technological degradation
    2. Limited track development since British time
    3. Considering freight secondary over passengers
    4. The issue of c==ross-subsidisation i.e.== the losses occurred in railway passenger trains were compensated with freight - **Bibek Debroy Committe****e recommended Railway reforms****:**
    ...
    - For enhancing safety in the Railwa==y== **KAVACH syste****m** has been introduced which is indigenous ==RFID to sense== and apply emergency breaks.
...
- **Investment Models:**
    ...
    - In terms of models, an investment could be:
        ...
        1. **Public Investment-** whereby raising savings and advancing sovereign loans government tries to invest (classical Harrod -Domar, Mahalanobis Approach)
        2. **Private Investment**- to facilitate the private sector locally and via foreign investments (FDI and FPI ) which facilitate credit flow, increase in demand and money multiplier impact
        3. **Public-Private Partnership -** In such investment models both the public sector and private sectors come together for
...
- **Different types of PPP models:**
    ...
    - **Vijay Kelkar Committee:** #remember-for-later
...
- **Recommendations****:**
    ...
    - To d==evelop PPP laws a==nd an ==independent regulator and facilitator==
...
- ![National wealth increased Wealth not distributed E...](Obsidian-files/Media/Exported%20image%2020250604062129-45.png)
- Goods
    
    1. Final Goods
        
        1. Will not further undergo economic transformation
    ...
    ![Who owns India Inc NSElisted in Dec21 Retail 97 Ot...](Obsidian-files/Media/Exported%20image%2020250604062131-46.png)
...
==Chapter - 6 Fiscal Policy== #remember-for-later #important  
==Chapter - 7 Monetary and Credit Policy== #remember-for-later #important  
==Chapter - 8 Money Market and Capital Market in India: Instruments and Dynamics== #remember-for-later #important  
==Chapter - 9 Stock Market== #remember-for-later #important  
==Chapter - 10 Inflation: Concepts, Facts and Policy== #remember-for-later #important  
Chapter - 11 Taxation  
Chapter - 12 Public Sector: Evolution, Reforms and Performance  
==Chapter - 13 Balance of Payment== #remember-for-later #important  
==Chapter - 14 Banking System In India== #remember-for-later #important  
==Chapter - 15 Bretton Woods Institutions: World Bank Group== #remember-for-later #important  
==Chapter - 16 Bretton Woods Institutions: International Monetary Fund (IMF)== #remember-for-later #important  
==Chapter - 17 World Trade Organization (WTO) - I== #remember-for-later #important  
==Chapter - 18 WTO and Intellectual Property Rights== #remember-for-later #important  
==Chapter - 19 Global Financial Architecture== #remember-for-later  
Chapter - 20 Poverty: Concepts, Data, Policy and Analysis #important  
Chapter - 21 Poverty Eradication and Randomized Controlled Trials (RCTs) #important  
Chapter - 22 Economic Inequality #important  
==Chapter - 23 Foreign Trade== #remember-for-later #important  
Chapter - 24 Infrastructure-I  
Chapter - 25 Infrastructure-II  
==Chapter - 26 Foreign Direct Investment== #remember-for-later  
...
- ==It is a measure of the== depth of poverty #remember-for-later
...
- ##### Lakdawala committee(1994)
    ...
    - Changes brought:
        ...
        1. Expanding poverty line basket
        2. Expanding poverty line to state-specific poverty line
        3. How to adjust the poverty line year over year based on scientific parameters based on ==CPI==
    ...
    - Updating of prices with regard to CPI (IW) for urban and rural areas respectively. - ##### Suresh Tendulkar committee (2004):
...
### **Multidimensional poverty index.** #important
...
- The ==modern explanation== of inequality is based on th==e concept of rule of law.==
...
- The proportion of th==e labour force t==hat is unable to get work is called unemployed.
...
- A person is deemed to be employed with ==100% intensity== if he was able to work for m==ore than 4 hours on== a particular day. 
- If he works for ==less than 4 hours but more than 1 hour, t==hen his employment intensity is ==only 50%==, otherwise, for ==less than 1 hour, it is zero.==
...
- ==The only reason for the firm to employ new factors of production would be if there are additional demands which require expansion of its production capacity I.e., requires new investment.== #remember-for-later
...
- Unemployment in which the capability of a person i==s== not fully utilised.
...
- ==It is a situation in which the additional output contributed by a worker is zero.== #remember-for-later
...
![File1951 to 2013 Trend Chart of Sector Share of To...](Obsidian-files/Media/Exported%20image%2020250604062133-47.png)  

**Sectoral share in the employment of various sectors in India**

![Indias Unique Job Crisis 08 Aug 2022](Obsidian-files/Media/Exported%20image%2020250604062134-48.png)     
...
- Avoiding Regulation :
- **The rigidity of labour laws:** #remember-for-later
...
- Demand depends on multiple factors. Such as the price of the good, price of related goods such as substitute or complementary goods, Disposable income, season, tastes and cultural preferences, population, etc. - The law of demand states that ceteris paribus i.e., keeping all other things equal, ==demand is inversely proportional to price==, i.e., when the price of a good increase the quantity demanded of that good decreases and vice-versa.
...
- ![Demand Curve Definition Shift Elasticity Examples](Obsidian-files/Media/Exported%20image%2020250604062136-49.png)
...
- If the ==income of people increase==s then they would demand a ==higher quantity== of any good which they were consuming earlier.
- In the new conditions of increased income, the relationship does not change. It is just that the ==curve shifts outward==s.
...
- When any other factor which was assumed to be constant changes i.e., the ==conditions for production change. Th==en the producer's willingness at a given price will change.
...
- For example, if the ==price of raw materials decrease==s then given each price the ==quantity produced== at each price would be ==more== than what was produced earlier.
...
![Normal and Inferior Goods](Obsidian-files/Media/Exported%20image%2020250604062141-50.png)   
...
- ==Capital goods are final goods.== #remember-for-later
...
- The other type o==f final goods the non-capital goods are called consumer goods.==
...
- Capital goods can be thought of as those final goods that a producer buys from other producers. #remember-for-later
...
**Terms related to inflation** #important
...
- ==Yield (Effective earning) = Interest Earned - Premium Paid== #remember-for-later - **Part I:**
...
- If someone expects interest rates to rise, they would then anticipate asset prices to fall 
    ...
    - [Bond prices are inversely proportional to interest rates]  #remember-for-later
...
**Liquidity Trap:** #important
    
**Money Supply**:
 
**Measures of Money Supply**: #important
...
|Gold reserves  <br>Foreign exchange reserves  <br>Foreign government bonds  <br>Indian government bonds  <br>Lending by RBI to Banks, Central and State Governments.|Cash in circulation.  <br>Deposits with RBI - of Banks, Central and State Governments.  <br>Loans that are taken by RBI|
...
- Bail in
    ...
    - ![BailIn](Obsidian-files/Media/Exported%20image%2020250604062143-51.png)
...
- It is the difference between the ==lending rate== of the bank on the loans it extends, and the ==deposit rat==e which the bank provides on the deposits placed in it.
- It is understood as the profit of the bank.
- Spread = Lending rate - Deposit rate = Profit of the bank. #remember-for-later
...
**BCBS & Basel 3 Prudential norms** #important
...
- ==Custom duty is still paid separately. Custom duty is not part of GST.== #remember-for-later
- GST is jointly implemented by centres & states.
    
    - It reduces the cost of compliance and increases the cost of non-compliance. #remember-for-later
 
**Revenue Neutral Rate(RNR)**
 
**Laffer Curve:**
    
**Tax Evasion:** #important
...
- **The ownership breaks up the companies.**
    ...
    - If promoters share is ==100 % is the wholesal==e.
    - If the ownership is 76 % and new entrant Mr. X which ==has 26 % I i==n such cases. Then Mr. X is ==a strategic partn==er
...
- This ==sensitive inde==x is an index to figure out the free-floating market capital of the top 30 companies.
...
- A l==arge capital c==ompany is one more tha==n 20,000 cr==ores market capital.
- A ==mid-cap is be==twee==n 5000 to 20,000 crores==, and a s==mall-cap is below 5000 crores.==
...
![Visualizing the Countries With the Most Oil Reserv...](Obsidian-files/Media/Exported%20image%2020250604062144-52.png)  
...
- This IBRD provides concessional loans to those countries who are having repayment capabilitie==s.==
...
- It was highlighted that there are ==75 countries acr==oss the globe that do not save and do not have repayment capability.
...
- This organization works as a platform and facilitated so that various public and private companies of member countries can raise funds in the international market by issuing bonds in their home currencies. E.g. - It is IFC that facilitate==s Masala Bonds for India.==
...
## **International Monetary Fund** #important
...
- ==Any country can take an unconditional loan from IMF, equal to their Gold Tranche without any interest rate and equal to a safe tranche with some interest rates== #remember-for-later
- ==However, yet another 100% (equal to Quota), also can be taken as a loan called a Credit Tranche== #remember-for-later
...
- The ==RTP is SDR== that a country is having to be used at their disposal without an interest rate 
    ...
    - For any given country, it is initially ==e==qual to the Gold Tranche but it may increase if:
...
- ==The SDR is neither a currency nor a claim on the IMF.== #remember-for-later
...
![Geography Seminar geographyseminary](Obsidian-files/Media/Exported%20image%2020250604062146-53.jpeg)  
![Installed GENERATION CAPACITYFUELWISE AS ON 310520...](Obsidian-files/Media/Exported%20image%2020250604062148-54.png)  
...
- ![Grey Hydrogen Process Steam Reforming Source Natur...](Obsidian-files/Media/Exported%20image%2020250604062149-55.png)
 
**Nuclear Energy**

- ==कुमार== ==ना== ==रोड़ा== ==भाटो== ==कक्कड़ो== ==से== ==मार== ==खाने== ==पर== ==(KNRK)== #remember-for-later
- ==भीम== ==थारी== ==जय== ==करा== ==(4)== ==(====BHMTJKKK====K====)== #remember-for-later
![shivajirao DIASTER CONSEQUENCES OF KOVVADA NUCLEAR...](Obsidian-files/Media/Exported%20image%2020250604062151-56.jpeg)  
...
- **BOT-TOLL-** in such models built operate toll and transfer - **Hybrid annuity**
    
    - In India, the HAM is a combination o==f== **BOT Annuity and EPC models.** 
...
- **Swiss challenge**
    ...
    - The Swiss challenge method is a process of giving contracts where any proponent with credentials can submit a development proposal to the government. That ==proposal will be made available online, a==nd a second proponent can give suggestions to improve and beat that proposal.”
