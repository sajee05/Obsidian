...
![Exported image](Obsidian-files/Media/Exported%20image%2020250604233519-46.png)

### Surrogacy:
   
![azt cdec actwo 4a](Obsidian-files/Media/Exported%20image%2020250604233516-45.png)
...
_Wage Gap:_  
![PVISIONIAS Rd hRn nan In e cz awech c ka e o853 PM...](Obsidian-files/Media/Exported%20image%2020250604233510-44.png)           
...
_Role of Caste in Politics_      _Role of state_   
...
**Indian joint family**
 _Features of typical joint family._   ![VISI on ev CORSI eta Saooa Inshhhm Qs](Obsidian-files/Media/Exported%20image%2020250604233508-43.png)
...
2. Basic attributes  
4. Salient features  
 ![VISIONIP act a lsobvhg 9hcleVnclence](Obsidian-files/Media/Exported%20image%2020250604233506-42.png)
...
|   |   |
|---|---|
||- Caste System<br>    <br>    - Introduction<br>        <br>        - According to ==Pew Research Survey 68%== Indians identify themselves as members of lower castes.<br>            <br>            - SC - 15%<br>            - ST - 8.6%<br>            - OBC - 52%<br>    - ![Cornmmgdi](Obsidian-files/Media/Exported%20image%2020250604233453-36.png)<br>    - Issues<br>        <br>        - ==ActionAid NGO -==  ==25%== ==of villages==, Lower caste people were refused work, or face wage discrimination.<br>        - Unequal distribution of SPEC Rewards<br>        - Politization of caste<br>      <br>    - Conclusion<br>        <br>        - Articles 14, 15, 16 of the Indian Constitution, which envisaged to undo historical injustice and discrimination have paved the way for making india a egalitarian society.<br>          <br>        <br>- Sects - They form alternative form of social organization and identity often cutting across caste, region and religion.|
||- Family System<br>    <br>    - ![0 ER C](Obsidian-files/Media/Exported%20image%2020250604233454-37.png)<br>    - ![tnmxGC l oaam BYdqrr nw QH ercg el0QQ](Obsidian-files/Media/Exported%20image%2020250604233459-38.png)<br>        - Correction - polygyny<br>    - ![60Qi OdIe_ locJ dam IOV 6 EonomiC COOPHru Volqe S ...](Obsidian-files/Media/Exported%20image%2020250604233501-39.png)<br>      <br>    - ![U F](Obsidian-files/Media/Exported%20image%2020250604233503-40.png)<br>      <br>    - ![Pugh 43 ud](Obsidian-files/Media/Exported%20image%2020250604233505-41.png)<br>    <br>    - Conclusion|
...
- **W****orld Urbanization Prospect Report, 2018:** - **NITI Aayog**:
    ...
    - Approx. 21 cities will run out of groundwater. - According to the **report** of t==he== **C. Rangarajan panel**==:==
...
- **Concept****-** ![Med eVlSlONlAS u vce](Obsidian-files/Media/Exported%20image%2020250604233449-35.png)
...
## Factors affecting Population Change
 ![kJOYkn 155 Ot vs e xFexkeA 65 0 153 ise 60 fr is O...](Obsidian-files/Media/Exported%20image%2020250604233446-34.png)- **It depends upon two factors**-
...
- **Against-**
    ...
    - Lack of among people wrt UCC.
        ...
        - For e.g. instead of using it as a tool for empowerment, uniformity, progressive laws, it is seen from the prism of religious differences.
...
|The sphere of politics is separate from the sphere of religion(mutually exclusive - distance at a ==arms length),== No one shall be discriminated against on the basis of religion he/she practices.<br><br>![Exported image](Obsidian-files/Media/Exported%20image%2020250604233440-32.png)|Although the state doesn't support any religion neither does it discourage any, provided religion is not interfering with the state or other citizen's rights|Religion can never interfere in politics, however, politics can interfere in religion to give effect to progressive voices within the religion and to disagree with certain aspects of it, for e.g. abolition of untouchability, and triple talaq. etc. Principled distance <br><br>![Exported image](Obsidian-files/Media/Exported%20image%2020250604233444-33.png)|
...
## Secularism
 ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233437-31.png)- Diversity in Unity = e.g. Patriarchy, marriage, patriotism, etc.
- **Bonds of Unity in India -** Geographical, regional, socio-cultural, Miscellaneous, 
    ...
    ![upl 24](Obsidian-files/Media/Exported%20image%2020250604233429-29.png)  
    - **Cultural Bond of Unity =** Teaching of the religious scriptures, earning religious merits by visiting religious shrines
    ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233431-30.png)  
...
- **According to** **Ericson** ==Ethnic groups are defined as, those who consider themselves culturally distinct and such groups may exist in hierarchical order in society.== ![VISIONIA ubc q dokd](Obsidian-files/Media/Exported%20image%2020250604233427-28.png)- People of an ethnic group have awareness of their similarities and how they are distinct from others which leads to the development of Ethnic identity, differential access to resources based on ethnic identity which leads to ==ethnic stratification -\> Ethnic antagonism -\> with the subjective realization of objective reality== leads to Ethno-nationalism.
...
- **Steve Bruce** says - There are two necessary conditions (but not sufficient) for the ==emergence of== fundamentalism==-==
    ...
    1. Modernisation
        ...
        - Rational/Progressive transformation
    2. Secularisation
...
- The overthrow of the colonial state is the only state that was only a necessary condition to fight communalism but not sufficient.
 ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233425-27.png)

3. Also the result of elite power struggle.
 ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233423-26.png)
...
## Manifestation of diversity:
 ![eVlSlONlAS 0](Obsidian-files/Media/Exported%20image%2020250604233420-25.png)- **NOTE: Kindly refer to the relevant diagram drawn by Smriti ma'am in the live class.**
...
- Any act of gender-based violence that results in physical, sexual, or mental harm is referred to as violence against women. ![41r 4](Obsidian-files/Media/Exported%20image%2020250604233417-24.png)  
![geeace Ytt 14 e 40 lndoue scehC](Obsidian-files/Media/Exported%20image%2020250604233412-23.png)  
![ence ms OVISIONIAS en Covue8 ov](Obsidian-files/Media/Exported%20image%2020250604233408-22.png)
...
# Society Class 07
 - ### Briefly discuss the potential of paternity leave to create gender equality in the labour market, also discuss the challenges associated.
     ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233406-21.png)  
![02 Y 3 0 0 0](Obsidian-files/Media/Exported%20image%2020250604233404-20.png)- Some noteworthy international precedents include **Sweden** which has mandated  ==480 days of paid leave== to be shared by both, with a minimum of 90 days by one partner. 
##### Zomato India provides 26 weeks of paid leave for new fathers.
...
- It is a paid leave period reserved exclusively for the fathers during childbirth. ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233402-19.png)  
_Paternity Leave:_  
...
- Irrespective of the educational status of women, the time for unpaid work remains roughly the same. ![00 0 3 5](Obsidian-files/Media/Exported%20image%2020250604233358-18.png)  
![Unpaid work Care work care of persons living in th...](Obsidian-files/Media/Exported%20image%2020250604233355-17.png)- 91.8% of women in India between the ages of 15 and 59 participated in unpaid domestic work for household members in 2019, as compared to 20% of men.
...
- Patriarchy reduces the development and growth avenues of women that causes women to stay deprived or be dependent on male members. ![lack](Obsidian-files/Media/Exported%20image%2020250604233347-14.png)
...
# Society Class 06
 ![0](Obsidian-files/Media/Exported%20image%2020250604233345-13.png)
...
_Women in agriculture:_  
- ### Sectors (agriculture, Industry, Service, Informal):
     ![en ln ervxb](Obsidian-files/Media/Exported%20image%2020250604233343-12.png)- ### Structure of answer in society ***template*** #important
     ![Ir0 vocJ orv O C eVlSlONlAS Pasvor d blace ecl](Obsidian-files/Media/Exported%20image%2020250604233340-11.png)- **NOTE: Kindly refer to the relevant diagram drawn by Smriti ma'am in the live class.**
...
- **E.g.:**
    ...
    1. Boy child is considered as the inheritor whereas a girl child is considered as 'Paraya Dhan'.
...
### How gender stereotyping impacts the social position of women:
 - **Manifestation of Gender**:
    ...
    - **Structural**:
        ...
        - Sexual division of labour (men-to earn livelihood, woman-take care of domestic chores) - **Concept of** **Gender** : Socially constructed aspect of differences between men and women.   ![9 ence](Obsidian-files/Media/Exported%20image%2020250604233338-10.png)
...
- According to ==ActionAid NGO====, In more than== ==25%== ==of villages,== l==ower caste people== are not allowed to work on the agricultural land as casual labour and also ==suffer== ==from== ==wage discrimination==.
...
- According to the study conducted by Amit Thorat and Omkar Joshi, 30% of Urban households are practising untouchabilit==y.==

### Counterarguments:
 ![eVlSlONlAS Cove VC 0 eooc lack IDI0er CAt](Obsidian-files/Media/Exported%20image%2020250604233332-9.png)- **Kindly refer to the relevant diagram drawn by Smriti ma'am in the live class.**
...
- **Mandal Commission** - With this, there was an alteration in caste structure where instead of vertical arrangement with stigma  there was a ==horizontal competition for backwardness== without any stigma ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233330-8.png)- Perspective of ==MN Srinivasan== in below diagram :-
...
_Role of state_  
![eVlSlONlAS 3 SeooQav Iana](Obsidian-files/Media/Exported%20image%2020250604233326-6.png)  
...
## Caste System
 ![marria were traditionally nsidered to 5 and genera...](Obsidian-files/Media/Exported%20image%2020250604233324-5.png)  
![stitution of 1 2 3 4 5 Role of traditional family ...](Obsidian-files/Media/Exported%20image%2020250604233323-4.png)  
...
- **Interpersonal relations -** ![Exported image](Obsidian-files/Media/Exported%20image%2020250604233321-3.png)- Longevity Dividend - Economic growth potential is created due to an increase in life expectancy
...
- ==Educational role of fami==ly is reduced due to diverse job opportunities and the specialised institution of knowledge.
...
##### Impact of globalisation on marriage
 - _Types_
    1. Marriage
        ...
        1. Sologamy (It refers to self-marriage (the act of self-love) )
...
|1. Status - The status that we acquire by birth. For example, based on gender, based on caste, etc is Ritual status and The status we achieve in our society based on our achievements is called secular status(achieved status).<br>2. ==Hierarchy== (its opposite is egalitarianism)<br>3. Strong ==religious== orientation - when religion is not only a matter of faith but governs social, political, and economic cultures of life. (Opposite of this is ==Rationality==)<br>4. ==Collectivism== (Opposite to individualism)<br>5. ==Particularism== _:_ It is characterized by "You show me the man, I show you the rule" (आदमी देख के बात अलग अलग प्रकार से बात होती है), Circumstances dictates how ideas and practices are applied i.e. Some people are more equal than others.(Its opposite is ==universalism==)|1. New social change:<br>    <br>    - Secular education.<br>    - ==English== language.<br>    - Printing technology.<br>    - Transport and communication.<br><br>-\> Dissemination of Ideas<br><br>3. New social order:<br>    <br>    - Industrialization<br>    - Urbanization.<br>    - New indicators of social status<br><br>-\> ==New elites class==. (with secular status)|1. ==Secular basis of status.==<br>2. Egalitarianism<br>3. ==Rationality== : is driven by scientific factors, logic, and facts.<br>4. Industrialization.<br>5. ==Universalism== : Everyone is equal and treated the same, that is ideas and practices can be applied everywhere without modification.|
 
### Impacts of British role on Indian society:
 - Based on the four basic attributes we can conclude that Indian society is a collection of multiple societies (it has a composite culture) - _A network of social relations based on patterns of interaction among the members is referred to as a society._
...
2. Progeny (major source of membership of any society is through reproduction)
3. Common culture
4. Independent existence

1. Based on the pattern of interaction we tend to develop social relationships (teacher-student, work colleagues, friends, relatives etc.)

# Society:
   
![If 3](Obsidian-files/Media/Exported%20image%2020250604233315-2.png)
 **Consolidate the information regarding sections/subsections at one place!!!** #important
...
### Social empowerment:
 - _3 aspects of a problem_ #important
    
    1. _Political empowerment_
    2. _Economic empowerment_
    3. _Social empowerment_
- Examples
...
**Cultural lag:**
 - Salad Bowl **-** It describes a heterogeneous society where different cultures are brought together as the salad's ingredients. However, the individual flavor is retained. _- this is mentioned to be promoted in the indian constitution._
...
- Melting pot **-** People of different cultures melt together, deserting their cultures and getting fully assimilated within the predominated society. (एक राष्ट्रीय पहचान में क्षेत्रीय पहचान का मिल जाना और खो जाना)
    ...
    - E.g. USA
- There are 2 schools of thought concerning multiculturalism, ==t==hat is melting-pot and salad bowl.
...
1. Perspective - problem statement
2. Body - multi dimensions of the problem statement, what can be done
3. Solution - what is the best way to solve the problem.
...
- To develop a perspective on the Indian Social System. (that would determine what is the solution you are proposing for the social issues and problems) ![Why to Study Society To develop the perspective on...](Obsidian-files/Media/Exported%20image%2020250604233312-1.png)  

### Why study society
 ![Weightage 100 75 625 10 75](Obsidian-files/Media/Exported%20image%2020250604233310-0.png)